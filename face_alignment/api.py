...
class FaceAlignment:
    def __init__(self, landmarks_type, network_size=NetworkSize.LARGE,
                 check_point_path=r'C:\Collins_Project\pain_detection_demo-master\face_alignment\2DFAN-4.pth',
        ...
        # Download this weight file from:
        ...
        # Paste the file under face_alignment folder
        fan_weights = torch.load(os.path.join(os.getcwd(), r'face_alignment\2DFAN-4.pth'), map_location=device)
